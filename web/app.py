...
async def api_soak_progress(user=Depends(require_auth)):
    ...
    try:
        ...
        # dieselbe Regel auf aktualisierte Daten. Nach dem Tranchen-Wegfall
        # (R-B28) wurde die Referenz neu erzeugt: PF stieg 1.41 -> 1.698, und das
        # 5%-Quantil ueberschreitet 1.0 jetzt bei n=80 (1.03) statt bei n=100.
        # Der bessere Motor braucht weniger Stichprobe fuer denselben Beweis;
        # 100 stehenzulassen waere willkuerlich statt vorsichtig (~5 Wochen ohne
